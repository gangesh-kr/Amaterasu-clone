...
export default function VisionSection() {
  ...
  return (
    <section id="vision-section" className="relative w-full bg-[#ffffff] md:pt-[18vh] pb-0 flex flex-col items-center z-10" >
      ...
      <div className="max-w-4xl mx-auto w-full text-center mt-4 px-6 md:px-16 relative z-10">
        ...
        <div className="flex items-center justify-center gap-3" style={{
          ...
          <span className="text-[12px] uppercase tracking-[0.2em] text-[#1E1B4B] font-bold">
            VISION
          </span>
        </div>
        ...
        <p
          ref={textRef}
          className="text-3xl md:text-5xl lg:text-[36px] leading-[1.3] font-normal tracking-[-0.01em] text-[#1E1B4B]"
